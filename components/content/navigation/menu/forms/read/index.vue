...
export default {
  methods: {
    ...mapActions({
      'dialogReadClose': 'content/navigation/menu/dialogReadClose',
    })
  },

  computed: {
    ...mapGetters({
      dialogRead: 'content/navigation/menu/dialogRead',
      currentMenu_read: 'content/navigation/menu/currentMenu_read',
    }),
  },
}
</script>
